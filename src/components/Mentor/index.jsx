        ...
        <div className="mb-6 lg:mb-0 rounded-box">
          <div className="relative block rounded-lg shadow-lg p-6 bg-base-200 border-solid border-2 border-rose-500">
            <div className="lg:flex flex-row items-center">
              ...
              <div className="grow-0 shrink-0 basis-auto w-full lg:w-7/12">
                <h5 className="text-lg font-bold mb-2 text-rose-500">
                  Aurellia Christie
                </h5>
                <p className="text-rose-300 mb-4 text-sm">
                  Full-stack data science
                </p>
                <ul className="list-inside flex mx-auto justify-center lg:justify-start">
                  <a href="#!" className="px-2 lg:pl-0 lg:pr-2">
        ...
        <div className="mb-6 lg:mb-0 rounded-box">
          <div className="relative block rounded-lg shadow-lg p-6 bg-base-200 border-solid border-2 border-sky-500">
            <div className="lg:flex flex-row items-center">
              <div className="grow-0 mask mask-hexagon shrink-0 basis-auto w-full lg:w-5/12 lg:pr-6">
                <img
                  src="https://supertype.ai/wp-content/uploads/2020/10/gerald-150x150.jpg"
                  alt="gerald bryan"
                  className="w-full rounded-md mb-6 lg:mb-0 filter grayscale sepia-25"
                />
              </div>
